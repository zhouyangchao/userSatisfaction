...
orgData2.Compared_to_different_channel_prices_LEVEL = orgData2.Compared_to_different_channel_prices_LEVEL.replace(1,'本产品低')
orgData2.Compared_to_different_channel_prices_LEVEL = orgData2.Compared_to_different_channel_prices_LEVEL.replace(0,'持平')
orgData2.Compared_to_different_channel_prices_LEVEL = orgData2.Compared_to_different_channel_prices_LEVEL.replace(-1,'本产品高')

orgData2.If_price_changed_in_a_short_time_LEVEL = orgData2.If_price_changed_in_a_short_time_LEVEL.replace(1,'购买价格便宜')
orgData2.If_price_changed_in_a_short_time_LEVEL = orgData2.If_price_changed_in_a_short_time_LEVEL.replace(0,'未明显变动')
